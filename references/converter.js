...
document.writeln('<table align="center" style="border:0px">');
document.writeln('<tr><td style="border:0px"><b>SAMPA: </b></td><td style="border:0px"><textarea id="t1" name="t1" onkeyup="t2.value = sampatoipa(t1.value);" style="font-size:20px; width:700px; height:150px" class="ipa"></textarea></td></tr>');
document.writeln('<tr><td style="border:0px"><b>IPA: </b></td><td style="border:0px"><textarea id="t2" name="t2" onkeyup="t1.value = ipatosampa(t2.value);" style="font-size:20px; width:700px; height:150px" class="ipa"></textarea></td></tr>');
